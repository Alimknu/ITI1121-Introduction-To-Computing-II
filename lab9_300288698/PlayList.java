...
public class PlayList {
    ...
    public static PlayList getSongsFromFile( String fileName ) throws IOException {
        ...
        while ((line = in.readLine()) != null){
            ...
            Song s = new Song(lineArray[0], lineArray[1], lineArray[2]);
            newList.addSong(s);
        }
        in.close();
        is.close();
    ...
    public void writeSongsToFile( String fileName ) throws IOException {
        ...
        for (int i = 0; i < index; i++){
            Song currentSong = getSongAt(i);
            String toBeWritten = currentSong.getName() + ":" + currentSong.getArtist() + ":" + currentSong.getAlbum() + "\n";
