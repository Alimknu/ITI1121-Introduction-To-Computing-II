...
public class TestL5Book {
    ...
    public void testNotEqualBooksDifferentTitle() {
      ...
      System.out.println("NOT EQUAL BOOKS DIFFERENT TITLE" + myBook.equals(myBook2));
    ...
    public void testNotEqualBooksDifferentYears() {
      ...
      System.out.println("NOT EQUAL BOOKS DIFFERENT YEARS" + myBook.equals(myBook2));
    ...
    public void testNotEqualNullAuthorParameter() {
      ...
      System.out.println("NOT EQUAL AUTHOR PARAMETER" + myBook.equals(myBook2));
    ...
    public void testNotEqualNullTitleParameter() {
      ...
      System.out.println("NOT EQUAL NULL TITLE PARAMETER" + myBook.equals(myBook2));
